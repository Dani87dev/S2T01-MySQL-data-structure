...
INSERT INTO customer (customer_id, name, surname, address, zip_code, town_id, phone_number)
VALUES (1, 'Joan', 'Garcia', 'Carrer Major 10', '08201', 1, 600000001),
       (2, 'Marta', 'Roca', 'Plaça Nova 5', '08221', 2, 600000002),
       (3, 'Pere', 'Vila', 'Av. Catalunya 12', '17600', 3, 600000003),
       (4, 'Anna', 'Serra', 'Carrer del Mar 2', '17300', 4, 600000004);
...
VALUES (1, 'Lluís', 'Pou', '12345678A', 600111222, 'cook', 1),
       (2, 'Sònia', 'Mas', '87654321B', 600333444, 'delivery', 1),
       (3, 'Marc', 'Soler', '11223344C', 600555666, 'cook', 2),
...
VALUES (1, 'Margarita', 'Tomàquet i mozzarella', 'pizza', 12.50, 1),
       (2, 'Cheeseburger', 'Formatge cheddar i carn buey', 'burger', 9.90, 4),
