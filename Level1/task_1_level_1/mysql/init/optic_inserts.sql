...
INSERT INTO address (address_id, street, number, floor, door, city, zip_code, country)
VALUES (1, 'Carrer Major', 10, '1r', '2a', 'Barcelona', '08001', 'Spain'),
       (2, 'Av. Diagonal', 450, '3r', '1a', 'Barcelona', '08006', 'Spain'),
       (3, 'Calle Alcalá', 22, 'Principal', 'B', 'Madrid', '28014', 'Spain'),
       (4, 'Rambla Nova', 5, 'Baixos', '1a', 'Tarragona', '43003', 'Spain');
...
INSERT INTO supplier (supplier_id, name, phone_number, fax_number, nif, address_id)
VALUES (1, 'Vision Group', 933123456, 933123457, 'B12345678', 1),
       (2, 'Optic Wholesale', 911445566, 911445567, 'A87654321', 3),
       (3, 'Luxottica Dist', 934556677, 934556678, 'B55566677', 2),
       (4, 'EuroGlass', 977112233, 977112234, 'C99988877', 4);
